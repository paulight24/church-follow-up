...
const es: Translations = {
  ...
  'resources.reachOutTitle': '¿Te gustaría que alguien se pusiera en contacto contigo?',
  'resources.reachOutBody': 'Todo lo anterior es gratuito. Esto es solo si quieres que te contactemos.',
  'resources.wantsContact': 'Sí, por favor que alguien de la iglesia me contacte.',
  'resources.interestsLabel': 'Me gustaría saber más sobre… (opcional)',
  'resources.interestReceiveChrist': 'Recibir a Cristo',
  'resources.interestLearnMore': 'Conocer más sobre la fe',
  'resources.interestJoinChurch': 'Unirme a la iglesia',
  'resources.interestCellGroup': 'Unirme a una célula cerca de mí',
  'resources.prayerLabel': '¿Cómo podemos orar por ti?',
  'resources.prayerPlaceholder': 'Cuéntanos por lo que te gustaría que el equipo orara contigo…',
  'resources.prayerPrivacy': 'Las peticiones de oración se tratan de forma privada y solo las ve el equipo de oración de la iglesia.',
  'resources.send': 'Enviar',
  'resources.needContact': 'Déjanos un correo electrónico o un número de teléfono para poder contactarte.',
  ...
  'resources.errorBody': 'Tuvimos problemas para cargar esta página. Inténtalo de nuevo en un momento.',
  'resources.emptyBody': 'Todavía no se ha añadido nada a esta página. Vuelve pronto.',
  'resources.contactTitle': 'Contacta con la iglesia',
  'event.detailsToggle': 'Acerca del evento',
