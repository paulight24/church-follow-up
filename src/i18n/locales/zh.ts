...
const zh: Translations = {
  ...
  'event.shareTitle': '邀请一位朋友同来',
  'event.shareBody': '轻触即可打开 WhatsApp，邀请内容已写好，您只需选择发送给谁。',
  'event.shareLead': '诚邀您参加 {event}',
  'event.shareWhatsApp': '通过 WhatsApp 分享',
  'event.shareCopy': '复制链接',
  'event.shareCopied': '链接已复制！',
  'event.shareMore': '更多…',
  'event.shareCopyManual': '请复制此链接：',
  ...
  'resources.reachOutTitle': '希望有人与您联系吗？',
  'resources.reachOutBody': '以上内容都可以免费取用。只有在您希望我们联系时才需要填写。',
  'resources.wantsContact': '是的，请教会的同工与我联系。',
  'resources.interestsLabel': '我想进一步了解……（选填）',
  'resources.interestReceiveChrist': '接受基督',
  'resources.interestLearnMore': '更多认识信仰',
  'resources.interestJoinChurch': '加入教会',
  'resources.interestCellGroup': '加入附近的小组',
  'resources.prayerLabel': '我们可以怎样为您祷告？',
  'resources.prayerPlaceholder': '请分享您希望团队与您一同祷告的事……',
  'resources.prayerPrivacy': '祷告事项将保密处理，仅由教会祷告团队查看。',
  'resources.send': '发送',
  'resources.needContact': '请留下电子邮箱或电话号码，方便我们与您联系。',
  ...
  'event.countdownHours': '小时',
  'event.countdownMinutes': '分',
  'event.countdownSeconds': '秒',
