...
const en = {
  ...
  'resources.reachOutTitle': 'Would you like someone to reach out to you?',
  'resources.reachOutBody': 'Everything above is free to take. This is only if you would like us to get in touch.',
  'resources.wantsContact': 'Yes, please have someone from the church contact me.',
  'resources.interestsLabel': 'I would like to know more about… (optional)',
  'resources.interestReceiveChrist': 'Receiving Christ',
  'resources.interestLearnMore': 'Learning more about the faith',
  'resources.interestJoinChurch': 'Joining the church',
  'resources.interestCellGroup': 'Joining a cell group near me',
  'resources.prayerLabel': 'How can we pray for you?',
  'resources.prayerPlaceholder': 'Share anything you would like the team to pray with you about…',
  'resources.prayerPrivacy': 'Prayer requests are treated privately and seen only by the church’s prayer team.',
  'resources.send': 'Send',
  'resources.needContact': 'Leave an email address or a phone number so we can reach you.',
