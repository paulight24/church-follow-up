...
const en = {
  ...
  'event.shareTitle': 'Bring someone with you',
  'event.shareBody': 'One tap opens WhatsApp with the invitation ready — you just choose who to send it to.',
  'event.shareLead': 'You’re invited to {event}',
  'event.shareWhatsApp': 'Share on WhatsApp',
  'event.shareCopy': 'Copy link',
  'event.shareCopied': 'Link copied!',
  'event.shareMore': 'More…',
  'event.shareCopyManual': 'Copy this link:',
